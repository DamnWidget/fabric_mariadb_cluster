mariadb_conf = """# MariaDB database server configuration file.
#
...
[mysqld]
#
# * Mandatory settings REQUIRED for proper cluster operations
#
query_cache_size=0
binlog_format=ROW
...
wsrep_sst_auth=root:{settings.mariadb_root_password}
